            ...
            <div class="row">
                ...
                <div class="col-md-12 row justify-content-center">
                    <div class="form-group"> <!-- propio de bootstrap -->
                        <form action="<?php echo $URL ?>/app/controllers/facturas_controllers/delete_factura_controller.php" method="post">
                            <input type="text" value="<?php echo $id; ?>" name="id" hidden>
                            <a href="show_factura.php" class="btn btn-secondary">Cancelar</a>
